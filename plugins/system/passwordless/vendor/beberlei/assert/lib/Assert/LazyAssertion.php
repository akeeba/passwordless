...
class LazyAssertion
{
     ...
     * @return static
     */
    public function setExceptionClass(string $className): \Akeeba\Passwordless\Assert\LazyAkeeba\Passwordless\Assertion
    {
        if (\Akeeba\Passwordless\Assert\LazyAkeeba\Passwordless\AssertionException::class !== $className && !\is_subclass_of($className, \Akeeba\Passwordless\Assert\LazyAkeeba\Passwordless\AssertionException::class)) {
            throw new LogicException($className.' is not (a subclass of) '.\Akeeba\Passwordless\Assert\LazyAkeeba\Passwordless\AssertionException::class);
        }
