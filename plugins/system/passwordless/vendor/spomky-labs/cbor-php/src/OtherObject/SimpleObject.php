...
final class SimpleObject extends \Akeeba\Passwordless\CBOR\OtherObject implements \Akeeba\Passwordless\CBOR\Normalizable
{
    ...
    public function normalize(): int
    {
        ...
        return \Akeeba\Passwordless\CBOR\Utils::binToInt($this->data);
    }
