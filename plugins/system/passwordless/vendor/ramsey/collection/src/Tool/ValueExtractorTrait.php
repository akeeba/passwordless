...
namespace Akeeba\Passwordless\Ramsey\Collection\Tool;

use Akeeba\Passwordless\Ramsey\Collection\Exception\ValueExtractionException;
...
trait ValueExtractorTrait
{
    ...
    {
        if (!is_object($object)) {
            throw new \Akeeba\Passwordless\Ramsey\Collection\Exception\ValueExtractionException('Unable to extract a value from a non-object');
        }
        ...
        throw new \Akeeba\Passwordless\Ramsey\Collection\Exception\ValueExtractionException(
