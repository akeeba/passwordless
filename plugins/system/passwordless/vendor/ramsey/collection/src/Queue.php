...
use Akeeba\Passwordless\Ramsey\Collection\Exception\NoSuchElementException;
 ...
 */
class Queue extends \Akeeba\Passwordless\Ramsey\Collection\AbstractArray implements \Akeeba\Passwordless\Ramsey\Collection\QueueInterface
{
    use \Akeeba\Passwordless\Ramsey\Collection\Tool\TypeTrait;
    use \Akeeba\Passwordless\Ramsey\Collection\Tool\ValueToStringTrait;
    ...
    public function element()
    {
        ...
        if ($element === null) {
            throw new \Akeeba\Passwordless\Ramsey\Collection\Exception\NoSuchElementException(
    ...
    public function offer($element): bool
    {
        ...
        } catch (\Akeeba\Passwordless\Ramsey\Collection\Exception\InvalidArgumentException $e) {
            return false;
        }
    }
    ...
    public function remove()
    {
        ...
        if ($head === null) {
            throw new \Akeeba\Passwordless\Ramsey\Collection\Exception\NoSuchElementException('Can\'t return element from Queue. Queue is empty.');
        }
