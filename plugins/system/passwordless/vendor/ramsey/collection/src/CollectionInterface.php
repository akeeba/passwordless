 ...
 */
interface CollectionInterface extends \Akeeba\Passwordless\Ramsey\Collection\ArrayInterface
{
    /**
     * Ascending sort type.
     */
     ...
     * @return CollectionInterface<T>
     */
    public function diff(\Akeeba\Passwordless\Ramsey\Collection\CollectionInterface $other): self;
     ...
     * @return CollectionInterface<T>
     */
    public function intersect(\Akeeba\Passwordless\Ramsey\Collection\CollectionInterface $other): self;
     ...
     * @return CollectionInterface<T>
     */
    public function merge(\Akeeba\Passwordless\Ramsey\Collection\CollectionInterface ...$collections): self;
}
