...
{
    return \Akeeba\Passwordless\Ramsey\Uuid\Uuid::uuid1($node, $clockSeq)->toString();
}
...
function v2(
    ...
    return \Akeeba\Passwordless\Ramsey\Uuid\Uuid::uuid2($localDomain, $localIdentifier, $node, $clockSeq)->toString();
}
...
{
    return \Akeeba\Passwordless\Ramsey\Uuid\Uuid::uuid3($ns, $name)->toString();
}
...
function v4(): string
{
    return \Akeeba\Passwordless\Ramsey\Uuid\Uuid::uuid4()->toString();
}
...
{
    return \Akeeba\Passwordless\Ramsey\Uuid\Uuid::uuid5($ns, $name)->toString();
}
 ...
 */
function v6(?\Akeeba\Passwordless\Ramsey\Uuid\Type\Hexadecimal $node = null, ?int $clockSeq = null): string
{
    return \Akeeba\Passwordless\Ramsey\Uuid\Uuid::uuid6($node, $clockSeq)->toString();
}
