 ...
 * @psalm-immutable
 */
class BigNumberConverter implements \Akeeba\Passwordless\Ramsey\Uuid\Converter\NumberConverterInterface
{
    /**
    ...
    {
        $this->converter = new \Akeeba\Passwordless\Ramsey\Uuid\Converter\Number\GenericNumberConverter(new \Akeeba\Passwordless\Ramsey\Uuid\Math\BrickMathCalculator());
    }
