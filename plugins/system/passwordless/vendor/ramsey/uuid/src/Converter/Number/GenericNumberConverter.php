...
namespace Akeeba\Passwordless\Ramsey\Uuid\Converter\Number;
 ...
 * @psalm-immutable
 */
class GenericNumberConverter implements \Akeeba\Passwordless\Ramsey\Uuid\Converter\NumberConverterInterface
{
    /**
    ...
    public function toHex(string $number): string
    {
        ...
        return $this->calculator->toBase(new \Akeeba\Passwordless\Ramsey\Uuid\Type\Integer($number), 16);
    }
}
