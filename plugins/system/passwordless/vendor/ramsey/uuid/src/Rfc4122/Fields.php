...
{
    use \Akeeba\Passwordless\Ramsey\Uuid\Rfc4122\NilTrait;
    use \Akeeba\Passwordless\Ramsey\Uuid\Fields\SerializableFieldsTrait;
    use \Akeeba\Passwordless\Ramsey\Uuid\Rfc4122\VariantTrait;
    use \Akeeba\Passwordless\Ramsey\Uuid\Rfc4122\VersionTrait;
    ...
    public function getTimestamp(): \Akeeba\Passwordless\Ramsey\Uuid\Type\Hexadecimal
    {
        switch ($this->getVersion()) {
            case \Akeeba\Passwordless\Ramsey\Uuid\Uuid::UUID_TYPE_DCE_SECURITY:
                $timestamp = sprintf(
                    '%03x%04s%08s',
                ...
                break;
            case \Akeeba\Passwordless\Ramsey\Uuid\Uuid::UUID_TYPE_PEABODY:
                $timestamp = sprintf(
                    '%08s%04s%03x',
        ...
        return new \Akeeba\Passwordless\Ramsey\Uuid\Type\Hexadecimal($timestamp);
    }
    ...
    private function isCorrectVariant(): bool
    {
        ...
        return $this->getVariant() === \Akeeba\Passwordless\Ramsey\Uuid\Uuid::RFC_4122;
    }
}
