 ...
 * @psalm-immutable
 */
final class UuidV2 extends \Akeeba\Passwordless\Ramsey\Uuid\Uuid implements \Akeeba\Passwordless\Ramsey\Uuid\Rfc4122\UuidInterface
{
    /**
    ...
    public function __construct(
        ...
        if ($fields->getVersion() !== \Akeeba\Passwordless\Ramsey\Uuid\Uuid::UUID_TYPE_DCE_SECURITY) {
    ...
    {
        return \Akeeba\Passwordless\Ramsey\Uuid\Uuid::DCE_DOMAIN_NAMES[$this->getLocalDomain()];
    }

    /**
     * Returns the local identifier for the domain used to create this version 2 UUID
     */
    public function getLocalIdentifier(): \Akeeba\Passwordless\Ramsey\Uuid\Type\Integer
    {
        /** @var Rfc4122FieldsInterface $fields */
        $fields = $this->getFields();

        return new \Akeeba\Passwordless\Ramsey\Uuid\Type\Integer(
