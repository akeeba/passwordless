...
use Akeeba\Passwordless\Ramsey\Uuid\Fields\FieldsInterface as BaseFieldsInterface;
 ...
 * @psalm-immutable
 */
interface FieldsInterface extends \Akeeba\Passwordless\Ramsey\Uuid\Fields\FieldsInterface
{
    /**
