...
use Akeeba\Passwordless\Ramsey\Uuid\Exception\InvalidBytesException;
...
trait VariantTrait
{
    ...
    public function getVariant(): int
    {
        if (strlen($this->getBytes()) !== 16) {
            throw new \Akeeba\Passwordless\Ramsey\Uuid\Exception\InvalidBytesException('Invalid number of bytes');
        }
        ...
        if ($msb === '111') {
            $variant = \Akeeba\Passwordless\Ramsey\Uuid\Uuid::RESERVED_FUTURE;
        } elseif ($msb === '110') {
            $variant = \Akeeba\Passwordless\Ramsey\Uuid\Uuid::RESERVED_MICROSOFT;
        } elseif (strpos($msb, '10') === 0) {
            $variant = \Akeeba\Passwordless\Ramsey\Uuid\Uuid::RFC_4122;
        } else {
            $variant = \Akeeba\Passwordless\Ramsey\Uuid\Uuid::RESERVED_NCS;
        }
