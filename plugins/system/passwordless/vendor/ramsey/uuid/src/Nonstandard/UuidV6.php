...
use Akeeba\Passwordless\Ramsey\Uuid\Exception\DateTimeException;
...
use Akeeba\Passwordless\Ramsey\Uuid\Rfc4122\UuidInterface;
 ...
 * @psalm-immutable
 */
final class UuidV6 extends \Akeeba\Passwordless\Ramsey\Uuid\Uuid implements \Akeeba\Passwordless\Ramsey\Uuid\Rfc4122\UuidInterface
{
    /**
    ...
    public function __construct(
        ...
        if ($fields->getVersion() !== \Akeeba\Passwordless\Ramsey\Uuid\Uuid::UUID_TYPE_PEABODY) {
    ...
    public function getDateTime(): DateTimeInterface
    {
        ...
        try {
            ...
            throw new \Akeeba\Passwordless\Ramsey\Uuid\Exception\DateTimeException($e->getMessage(), (int) $e->getCode(), $e);
        }
    }
    ...
    public function toUuidV1(): \Akeeba\Passwordless\Ramsey\Uuid\Rfc4122\UuidV1
    {
        ...
        $uuid = \Akeeba\Passwordless\Ramsey\Uuid\Uuid::fromBytes((string) hex2bin($hex));
     ...
     */
    public static function fromUuidV1(\Akeeba\Passwordless\Ramsey\Uuid\Rfc4122\UuidV1 $uuidV1): \Akeeba\Passwordless\Ramsey\Uuid\Nonstandard\UuidV6
    {
