...
class NameGeneratorFactory
{
     ...
     */
    public function getGenerator(): \Akeeba\Passwordless\Ramsey\Uuid\Generator\NameGeneratorInterface
    {
        return new \Akeeba\Passwordless\Ramsey\Uuid\Generator\DefaultNameGenerator();
    }
}
