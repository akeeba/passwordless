...
final class Fields implements \Akeeba\Passwordless\Ramsey\Uuid\Rfc4122\FieldsInterface
{
    ...
    public function getTimeLow(): \Akeeba\Passwordless\Ramsey\Uuid\Type\Hexadecimal
    {
        ...
        return new \Akeeba\Passwordless\Ramsey\Uuid\Type\Hexadecimal((string) ($hex[1] ?? ''));
    }
    ...
    private function isCorrectVariant(): bool
    {
        ...
        return $variant === \Akeeba\Passwordless\Ramsey\Uuid\Uuid::RFC_4122 || $variant === \Akeeba\Passwordless\Ramsey\Uuid\Uuid::RESERVED_MICROSOFT;
    }
}
