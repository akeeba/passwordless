...
use Akeeba\Passwordless\Ramsey\Uuid\Generator\DefaultTimeGenerator;
...
use Akeeba\Passwordless\Ramsey\Uuid\Lazy\LazyUuidFromString;
use Akeeba\Passwordless\Ramsey\Uuid\Provider\NodeProviderInterface;
use Akeeba\Passwordless\Ramsey\Uuid\Provider\Time\FixedTimeProvider;
...
class UuidFactory implements \Akeeba\Passwordless\Ramsey\Uuid\UuidFactoryInterface
{
    /**
     * @var CodecInterface
     */
     ...
     */
    public function __construct(?\Akeeba\Passwordless\Ramsey\Uuid\FeatureSet $features = null)
    {
        $this->isDefaultFeatureSet = $features === null;

        $features = $features ?: new \Akeeba\Passwordless\Ramsey\Uuid\FeatureSet();
     ...
     */
    public function setCodec(\Akeeba\Passwordless\Ramsey\Uuid\Codec\CodecInterface $codec): void
    {
     ...
     */
    public function setNameGenerator(\Akeeba\Passwordless\Ramsey\Uuid\Generator\NameGeneratorInterface $nameGenerator): void
    {
        $this->isDefaultFeatureSet = false;
     ...
     */
    public function setTimeGenerator(\Akeeba\Passwordless\Ramsey\Uuid\Generator\TimeGeneratorInterface $generator): void
    {
        $this->isDefaultFeatureSet = false;
     ...
     */
    public function setDceSecurityGenerator(\Akeeba\Passwordless\Ramsey\Uuid\Generator\DceSecurityGeneratorInterface $generator): void
    {
        $this->isDefaultFeatureSet = false;
     ...
     */
    public function setRandomGenerator(\Akeeba\Passwordless\Ramsey\Uuid\Generator\RandomGeneratorInterface $generator): void
    {
        $this->isDefaultFeatureSet = false;
     ...
     */
    public function setNumberConverter(\Akeeba\Passwordless\Ramsey\Uuid\Converter\NumberConverterInterface $converter): void
    {
        $this->isDefaultFeatureSet = false;
     ...
     */
    public function getUuidBuilder(): \Akeeba\Passwordless\Ramsey\Uuid\Builder\UuidBuilderInterface
    {
     ...
     *     of UuidInterface
     */
    public function setUuidBuilder(\Akeeba\Passwordless\Ramsey\Uuid\Builder\UuidBuilderInterface $builder): void
    {
        $this->isDefaultFeatureSet = false;
     ...
     * @psalm-pure
     */
    public function fromBytes(string $bytes): \Akeeba\Passwordless\Ramsey\Uuid\UuidInterface
    {
     ...
     * @psalm-pure
     */
    public function fromString(string $uuid): \Akeeba\Passwordless\Ramsey\Uuid\UuidInterface
    {
     ...
     * @psalm-pure
     */
    public function fromInteger(string $integer): \Akeeba\Passwordless\Ramsey\Uuid\UuidInterface
    {
    ...
    public function fromDateTime(
        ...
        ?int $clockSeq = null
    ): \Akeeba\Passwordless\Ramsey\Uuid\UuidInterface {
        $timeProvider = new \Akeeba\Passwordless\Ramsey\Uuid\Provider\Time\FixedTimeProvider(
            new \Akeeba\Passwordless\Ramsey\Uuid\Type\Time($dateTime->format('U'), $dateTime->format('u'))
        );

        $timeGenerator = new \Akeeba\Passwordless\Ramsey\Uuid\Generator\DefaultTimeGenerator(
            $this->nodeProvider,
            $this->timeConverter,
            $timeProvider
        );
     ...
     * @inheritDoc
     */
    public function uuid1($node = null, ?int $clockSeq = null): \Akeeba\Passwordless\Ramsey\Uuid\UuidInterface
    {
     ...
     * @psalm-pure
     */
    public function uuid3($ns, string $name): \Akeeba\Passwordless\Ramsey\Uuid\UuidInterface
    {
        return $this->uuidFromNsAndName($ns, $name, 3, 'md5');
    }

    public function uuid4(): \Akeeba\Passwordless\Ramsey\Uuid\UuidInterface
    {
     ...
     * @psalm-pure
     */
    public function uuid5($ns, string $name): \Akeeba\Passwordless\Ramsey\Uuid\UuidInterface
    {
        return $this->uuidFromNsAndName($ns, $name, 5, 'sha1');
    }

    public function uuid6(?\Akeeba\Passwordless\Ramsey\Uuid\Type\Hexadecimal $node = null, ?int $clockSeq = null): \Akeeba\Passwordless\Ramsey\Uuid\UuidInterface
    {
        $nodeHex = $node ? $node->toString() : null;
     ...
     * @psalm-pure
     */
    public function uuid(string $bytes): \Akeeba\Passwordless\Ramsey\Uuid\UuidInterface
    {
     ...
     * @psalm-pure
     */
    private function uuidFromNsAndName($ns, string $name, int $version, string $hashAlgorithm): \Akeeba\Passwordless\Ramsey\Uuid\UuidInterface
    {
        if (!($ns instanceof \Akeeba\Passwordless\Ramsey\Uuid\UuidInterface)) {
     ...
     * @psalm-pure
     */
    private function uuidFromBytesAndVersion(string $bytes, int $version): \Akeeba\Passwordless\Ramsey\Uuid\UuidInterface
    {
        /** @var array $unpackedTime */
        $unpackedTime = unpack('n*', substr($bytes, 6, 2));
        $timeHi = (int) $unpackedTime[1];
        $timeHiAndVersion = pack('n*', \Akeeba\Passwordless\Ramsey\Uuid\BinaryUtils::applyVersion($timeHi, $version));

        /** @var array $unpackedClockSeq */
        $unpackedClockSeq = unpack('n*', substr($bytes, 8, 2));
        $clockSeqHi = (int) $unpackedClockSeq[1];
        $clockSeqHiAndReserved = pack('n*', \Akeeba\Passwordless\Ramsey\Uuid\BinaryUtils::applyVariant($clockSeqHi));

        $bytes = substr_replace($bytes, $timeHiAndVersion, 6, 2);
        $bytes = substr_replace($bytes, $clockSeqHiAndReserved, 8, 2);

        if ($this->isDefaultFeatureSet) {
            return \Akeeba\Passwordless\Ramsey\Uuid\Lazy\LazyUuidFromString::fromBytes($bytes);
        }
