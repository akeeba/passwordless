...
namespace Akeeba\Passwordless\Ramsey\Uuid\Type;
 ...
 * @psalm-immutable
 */
final class Time implements \Akeeba\Passwordless\Ramsey\Uuid\Type\TypeInterface
{
    /**
     * @var IntegerObject
     */
    ...
    {
        $this->seconds = new \Akeeba\Passwordless\Ramsey\Uuid\Type\Integer($seconds);
        $this->microseconds = new \Akeeba\Passwordless\Ramsey\Uuid\Type\Integer($microseconds);
    }

    public function getSeconds(): \Akeeba\Passwordless\Ramsey\Uuid\Type\Integer
    {
        return $this->seconds;
    }

    public function getMicroseconds(): \Akeeba\Passwordless\Ramsey\Uuid\Type\Integer
    {
