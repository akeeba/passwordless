 ...
 */
class RandomNodeProvider implements \Akeeba\Passwordless\Ramsey\Uuid\Provider\NodeProviderInterface
{
    public function getNode(): \Akeeba\Passwordless\Ramsey\Uuid\Type\Hexadecimal
    {
        ...
        return new \Akeeba\Passwordless\Ramsey\Uuid\Type\Hexadecimal(str_pad(bin2hex($node), 12, '0', STR_PAD_LEFT));
    }
}
