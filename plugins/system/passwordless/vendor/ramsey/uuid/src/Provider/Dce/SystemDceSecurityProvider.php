...
namespace Akeeba\Passwordless\Ramsey\Uuid\Provider\Dce;
 ...
 */
class SystemDceSecurityProvider implements \Akeeba\Passwordless\Ramsey\Uuid\Provider\DceSecurityProviderInterface
{
    /**
     ...
     * @inheritDoc
     */
    public function getUid(): \Akeeba\Passwordless\Ramsey\Uuid\Type\Integer
    {
        static $uid = null;

        if ($uid instanceof \Akeeba\Passwordless\Ramsey\Uuid\Type\Integer) {
            return $uid;
        }
        ...
        $uid = new \Akeeba\Passwordless\Ramsey\Uuid\Type\Integer($uid);
     ...
     * @inheritDoc
     */
    public function getGid(): \Akeeba\Passwordless\Ramsey\Uuid\Type\Integer
    {
        static $gid = null;

        if ($gid instanceof \Akeeba\Passwordless\Ramsey\Uuid\Type\Integer) {
            return $gid;
        }
        ...
        $gid = new \Akeeba\Passwordless\Ramsey\Uuid\Type\Integer($gid);
