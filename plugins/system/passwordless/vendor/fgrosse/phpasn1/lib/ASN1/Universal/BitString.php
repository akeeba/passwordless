...
class BitString extends \Akeeba\Passwordless\FG\ASN1\Universal\OctetString implements \Akeeba\Passwordless\FG\ASN1\Parsable
{
    ...
    {
        return \Akeeba\Passwordless\FG\ASN1\Identifier::BITSTRING;
    }
    ...
    {
        self::parseIdentifier($binaryData[$offsetIndex], \Akeeba\Passwordless\FG\ASN1\Identifier::BITSTRING, $offsetIndex++);
        ...
        if ($nrOfUnusedBits > 7 || // no less than 1 used, otherwise non-minimal
            ...
            throw new \Akeeba\Passwordless\FG\ASN1\Exception\ParserException("Can not parse bit string with invalid padding", $offsetIndex);
        }
