 ...
 */
class GeneralizedTime extends \Akeeba\Passwordless\FG\ASN1\AbstractTime implements \Akeeba\Passwordless\FG\ASN1\Parsable
{
    ...
    {
        return \Akeeba\Passwordless\FG\ASN1\Identifier::GENERALIZED_TIME;
    }
    ...
    {
        self::parseIdentifier($binaryData[$offsetIndex], \Akeeba\Passwordless\FG\ASN1\Identifier::GENERALIZED_TIME, $offsetIndex++);
        ...
        if ($contentLength == $lengthOfMinimumTimeString) {
            ...
            if ($maximumBytesToRead > 0) {
                ...
                || $binaryData[$offsetIndex] == '-') {
                    ...
                    throw new \Akeeba\Passwordless\FG\ASN1\Exception\ParserException('Invalid ISO 8601 Time String', $offsetIndex);
                }
            }
        }
