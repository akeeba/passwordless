...
use Akeeba\Passwordless\FG\ASN1\Exception\NotImplementedException;
use Akeeba\Passwordless\FG\ASN1\ASNObject;
use Akeeba\Passwordless\FG\ASN1\Universal\Set;

class RelativeDistinguishedName extends \Akeeba\Passwordless\FG\ASN1\Universal\Set
{
    /**
     * @param string|\FG\ASN1\Universal\ObjectIdentifier $objIdentifierString
     * @param \FG\ASN1\ASNObject $value
     */
    public function __construct($objIdentifierString, \Akeeba\Passwordless\FG\ASN1\ASNObject $value)
    {
        ...
        parent::__construct(new \Akeeba\Passwordless\FG\ASN1\Composite\AttributeTypeAndValue($objIdentifierString, $value));
    }
    ...
    {
        throw new \Akeeba\Passwordless\FG\ASN1\Exception\NotImplementedException();
    }
}
