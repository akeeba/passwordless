...
class TemplateParser
{
    ...
    {
        $parsedObject = \Akeeba\Passwordless\FG\ASN1\ASNObject::fromBinary($binary);
    ...
    private function validate(\Akeeba\Passwordless\FG\ASN1\ASNObject $object, $key, $value)
    {
        if (is_array($value)) {
    ...
    private function assertTypeId($expectedTypeId, \Akeeba\Passwordless\FG\ASN1\ASNObject $object)
    {
