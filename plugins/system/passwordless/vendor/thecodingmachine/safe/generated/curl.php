...
use Akeeba\Passwordless\Safe\Exceptions\CurlException;
...
function curl_escape($ch, string $str): string
{
    ...
    if ($result === false) {
        throw \Akeeba\Passwordless\Safe\Exceptions\CurlException::createFromCurlResource($ch);
    }
    return $result;
}
...
function curl_init(string $url = null)
{
    ...
    if ($result === false) {
        throw \Akeeba\Passwordless\Safe\Exceptions\CurlException::createFromPhpError();
    }
    return $result;
}
