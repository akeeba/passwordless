...
class MetadataTOCPayload implements JsonSerializable
{
    ...
    public function addEntry(\Akeeba\Passwordless\Webauthn\MetadataService\MetadataTOCPayloadEntry $entry): self
    {
        $this->entries[] = $entry;
    ...
    public static function createFromArray(array $data): self
    {
        ...
        foreach ($data['entries'] as $k => $entry) {
            $object->addEntry(\Akeeba\Passwordless\Webauthn\MetadataService\MetadataTOCPayloadEntry::createFromArray($entry));
        }
    ...
    public function jsonSerialize(): array
    {
        $data = [
            ...
            'no' => $this->no,
            'entries' => array_map(static function (\Akeeba\Passwordless\Webauthn\MetadataService\MetadataTOCPayloadEntry $object): array {
