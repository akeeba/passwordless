...
use Akeeba\Passwordless\Webauthn\AuthenticationExtensions\AuthenticationExtension;
...
abstract class PublicKeyCredentialOptions implements JsonSerializable
{
    ...
    public function __construct(string $challenge, ?int $timeout = null, ?\Akeeba\Passwordless\Webauthn\AuthenticationExtensions\AuthenticationExtensionsClientInputs $extensions = null)
    {
        if (null !== $timeout) {
        ...
        $this->extensions = $extensions ?? new \Akeeba\Passwordless\Webauthn\AuthenticationExtensions\AuthenticationExtensionsClientInputs();
    }
    ...
    public function addExtension(\Akeeba\Passwordless\Webauthn\AuthenticationExtensions\AuthenticationExtension $extension): self
    {
    ...
    public function setExtensions(\Akeeba\Passwordless\Webauthn\AuthenticationExtensions\AuthenticationExtensionsClientInputs $extensions): self
    {
    ...
    public function getExtensions(): \Akeeba\Passwordless\Webauthn\AuthenticationExtensions\AuthenticationExtensionsClientInputs
    {
