...
class CertificateToolbox
{
    ...
    {
        $untrustedFilename = \Akeeba\Passwordless\Safe\tempnam($folder, $prefix);
        \Akeeba\Passwordless\Safe\rename($untrustedFilename, $untrustedFilename.$suffix);
        \Akeeba\Passwordless\Safe\file_put_contents($untrustedFilename.$suffix, $certificate, FILE_APPEND);
        \Akeeba\Passwordless\Safe\file_put_contents($untrustedFilename.$suffix, PHP_EOL, FILE_APPEND);
