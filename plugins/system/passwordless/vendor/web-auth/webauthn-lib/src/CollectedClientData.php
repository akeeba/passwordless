...
use Akeeba\Passwordless\Webauthn\TokenBinding\TokenBinding;
...
class CollectedClientData
{
    ...
    public function getTokenBinding(): ?\Akeeba\Passwordless\Webauthn\TokenBinding\TokenBinding
    {
        return null === $this->tokenBinding ? null : \Akeeba\Passwordless\Webauthn\TokenBinding\TokenBinding::createFormArray($this->tokenBinding);
    }
    ...
    {
        if (!$this->has($key)) {
            throw new InvalidArgumentException(\Akeeba\Passwordless\Safe\sprintf('The key "%s" is missing', $key));
        }
