...
class PublicKeyCredentialRequestOptions extends \Akeeba\Passwordless\Webauthn\PublicKeyCredentialOptions
{
     ...
     */
    public function __construct(string $challenge, ?int $timeout = null, ?string $rpId = null, array $allowCredentials = [], ?string $userVerification = null, ?\Akeeba\Passwordless\Webauthn\AuthenticationExtensions\AuthenticationExtensionsClientInputs $extensions = null)
    {
    ...
    public function allowCredential(\Akeeba\Passwordless\Webauthn\PublicKeyCredentialDescriptor $allowCredential): self
    {
    ...
    public function jsonSerialize(): array
    {
        ...
        if (0 !== count($this->allowCredentials)) {
            $json['allowCredentials'] = array_map(static function (\Akeeba\Passwordless\Webauthn\PublicKeyCredentialDescriptor $object): array {
