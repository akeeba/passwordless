...
class Ec2Key extends \Akeeba\Passwordless\Cose\Key\Key
{
    ...
    public function asPEM(): string
    {
        if ($this->isPrivate()) {
            $der = new \Akeeba\Passwordless\FG\ASN1\Universal\Sequence(
                new \Akeeba\Passwordless\FG\ASN1\Universal\Integer(1),
                new \Akeeba\Passwordless\FG\ASN1\Universal\OctetString(bin2hex($this->d())),
                new \Akeeba\Passwordless\FG\ASN1\ExplicitlyTaggedObject(0, new \Akeeba\Passwordless\FG\ASN1\Universal\ObjectIdentifier($this->getCurveOid())),
                new \Akeeba\Passwordless\FG\ASN1\ExplicitlyTaggedObject(1, new \Akeeba\Passwordless\FG\ASN1\Universal\BitString(bin2hex($this->getUncompressedCoordinates())))
            );
        ...
        $der = new \Akeeba\Passwordless\FG\ASN1\Universal\Sequence(
            new \Akeeba\Passwordless\FG\ASN1\Universal\Sequence(
                new \Akeeba\Passwordless\FG\ASN1\Universal\ObjectIdentifier('1.2.840.10045.2.1'),
                new \Akeeba\Passwordless\FG\ASN1\Universal\ObjectIdentifier($this->getCurveOid())
            ),
            new \Akeeba\Passwordless\FG\ASN1\Universal\BitString(bin2hex($this->getUncompressedCoordinates()))
        );
