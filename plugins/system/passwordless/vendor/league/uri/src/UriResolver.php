...
final class UriResolver
{
    ...
    {
        if (!$uri instanceof \Akeeba\Passwordless\League\Uri\Contracts\UriInterface && !$uri instanceof Psr7UriInterface) {
    ...
    private static function removeDotSegments(string $path): string
    {
        ...
        $new_path = implode('/', array_reduce($old_segments, [\Akeeba\Passwordless\League\Uri\UriResolver::class, 'reducer'], []));
    ...
    private static function formatHost($uri)
    {
        ...
        return $uri->withHost((string) \Akeeba\Passwordless\League\Uri\Uri::createFromComponents(['host' => $host])->getHost());
    }
    ...
    {
        return !\Akeeba\Passwordless\League\Uri\UriInfo::isRelativePath($uri)
