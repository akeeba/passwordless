...
final class VariableBag
{
    ...
    private function normalizeValue($value, string $name, bool $isNestedListAllowed)
    {
        ...
        if (!$isNestedListAllowed) {
            throw \Akeeba\Passwordless\League\Uri\Exceptions\TemplateCanNotBeExpanded::dueToNestedListOfValue($name);
        }
     ...
     */
    public function replace(\Akeeba\Passwordless\League\Uri\UriTemplate\VariableBag $variables): self
    {
        $instance = clone $this;
