...
use Akeeba\Passwordless\League\Uri\UriTemplate\Template;
use Akeeba\Passwordless\League\Uri\UriTemplate\VariableBag;
...
final class UriTemplate
{
    ...
    {
        $this->template = \Akeeba\Passwordless\League\Uri\UriTemplate\Template::createFromString($template);
     ...
     */
    private function filterVariables(array $variables): \Akeeba\Passwordless\League\Uri\UriTemplate\VariableBag
    {
        $output = new \Akeeba\Passwordless\League\Uri\UriTemplate\VariableBag();
     ...
     */
    public function expand(array $variables = []): \Akeeba\Passwordless\League\Uri\Contracts\UriInterface
    {
        $uriString = $this->template->expand(
            $this->filterVariables($variables)->replace($this->defaultVariables)
        );

        return \Akeeba\Passwordless\League\Uri\Uri::createFromString($uriString);
    }
}
