...
class Authentication
{
	...
	public function getKnownAuthenticators(): array
	{
		...
		$image = HTMLHelper::_('image', 'plg_system_passwordless/fido.png', '', '', true, true);
		$image = $image ? JPATH_ROOT . substr($image, \strlen(Uri::root(true))) : (JPATH_BASE . '/media/plg_system_passwordless/images/fido.png');
